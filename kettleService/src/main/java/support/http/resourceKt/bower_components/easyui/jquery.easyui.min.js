...
(function($){
function init(_1eb){
$(_1eb).addClass("tooltip2-f");
};
function _1ec(_1ed){
var opts=$.data(_1ed,"tooltip2").options;
$(_1ed).unbind(".tooltip2").bind(opts.showEvent+".tooltip2",function(e){
$(_1ed).tooltip2("show",e);
}).bind(opts.hideEvent+".tooltip2",function(e){
$(_1ed).tooltip2("hide",e);
}).bind("mousemove.tooltip2",function(e){
if(opts.trackMouse){
opts.trackMouseX=e.pageX;
opts.trackMouseY=e.pageY;
$(_1ed).tooltip2("reposition");
}
});
};
function _1ee(_1ef){
var _1f0=$.data(_1ef,"tooltip2");
if(_1f0.showTimer){
...
$(_1f2).tooltip2("arrow").css("left",tip._outerWidth()/2+pos.left);
pos.left=0;
}
}else{
...
$(_1f2).tooltip2("arrow").css("left",tip._outerWidth()/2-(pos.left-left));
}
}
}
}
...
tip.removeClass("tooltip2-top tooltip2-bottom tooltip2-left tooltip2-right").addClass("tooltip2-"+opts.position);
var left,top;
if(opts.trackMouse){
t=$();
...
var _1f8=$.data(_1f7,"tooltip2");
var opts=_1f8.options;
var tip=_1f8.tip;
if(!tip){
tip=$("<div tabindex=\"-1\" class=\"tooltip2\">"+"<div class=\"tooltip2-content\"></div>"+"<div class=\"tooltip2-arrow-outer\"></div>"+"<div class=\"tooltip2-arrow\"></div>"+"</div>").appendTo("body");
_1f8.tip=tip;
_1f9(_1f7);
}
_1ee(_1f7);
_1f8.showTimer=setTimeout(function(){
$(_1f7).tooltip2("reposition");
tip.show();
opts.onShow.call(_1f7,e);
var _1fa=tip.children(".tooltip2-arrow-outer");
var _1fb=tip.children(".tooltip2-arrow");
...
_201.tip.children(".tooltip2-content").html(cc);
opts.onUpdate.call(_1ff,cc);
};
function _202(_203){
var _204=$.data(_203,"tooltip2");
if(_204){
_1ee(_203);
...
$.removeData(_203,"tooltip2");
$(_203).unbind(".tooltip2").removeClass("tooltip2-f");
opts.onDestroy.call(_203);
}
};
$.fn.tooltip2=function(_205,_206){
if(typeof _205=="string"){
return $.fn.tooltip2.methods[_205](this,_206);
}
_205=_205||{};
return this.each(function(){
var _207=$.data(this,"tooltip2");
if(_207){
$.extend(_207.options,_205);
}else{
$.data(this,"tooltip2",{options:$.extend({},$.fn.tooltip2.defaults,$.fn.tooltip2.parseOptions(this),_205)});
init(this);
}
_1ec(this);
_1f9(this);
...
$.fn.tooltip2.methods={options:function(jq){
...
$.fn.tooltip2.parseOptions=function(_209){
var t=$(_209);
...
$.fn.tooltip2.defaults={position:"bottom",content:null,trackMouse:false,deltaX:0,deltaY:0,showEvent:"mouseenter",hideEvent:"mouseleave",showDelay:200,hideDelay:100,onShow:function(e){
},onHide:function(e){
...
$(_452).tooltip2($.extend({},opts.tipOptions,{content:_453.message,position:opts.tipPosition,deltaX:opts.deltaX})).tooltip2("show");
_453.tip=true;
};
function _447(_454){
var _455=$.data(_454,"validatebox");
if(_455&&_455.tip){
$(_454).tooltip2("reposition");
}
};
function _44b(_456){
...
$(this).tooltip2("tip").css({color:"#000",borderColor:"#CC9933",backgroundColor:"#FFFFCC"});
},onHide:function(){
$(this).tooltip2("destroy");
...
//alert(opts.width)
opts.onResize.call(_47f,"100%",opts.height);
function _487(_489){
